...
export default function Onboarding() {
  ...
  const createCompanyMutation = useMutation({
    ...
    onSuccess: (company) => {
      ...
      // Store company data and show document wizard
      setCreatedCompany(company);
      setShowDocumentWizard(true);
      
      toast({
        title: "Company Created Successfully!",
        description: `${company.name} is ready. Let's create your essential documents.`,
      });
    },
    onError: (error) => {
            ...
            <DocumentSetupWizard 
              ...
              onComplete={() => {
                ...
                toast({
                  ...
                  description: "Your company is ready with essential compliance documents.",
                });
                setTimeout(() => {

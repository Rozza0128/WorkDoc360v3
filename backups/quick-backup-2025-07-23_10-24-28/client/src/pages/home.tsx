  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-charcoal">Welcome back, {user?.firstName || "User"}!</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {user?.email === 'admin@workdoc360.com' && (
              ...
              {companies && companies.length > 0 && companies[0] && (
                <div className="mb-8">
                  <h2 className="text-xl font-semibold text-charcoal mb-6">
                    Document Library for {getTradeLabel(companies[0].tradeType)}
                  </h2>
                  <TradeSpecificDocuments 
                    tradeType={companies[0].tradeType} 
                    userPlan="essential" 
                  />
                </div>
              )}

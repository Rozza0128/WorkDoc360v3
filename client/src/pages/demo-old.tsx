      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white py-6">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-3xl font-bold mb-2">
            🚀 See AI Create Professional Documents
          </h1>
          <p className="text-xl opacity-90 mb-3">
            Don't take our word for it — here's a scaffold RAMS document created by our AI using real construction data and UK regulations.
          </p>

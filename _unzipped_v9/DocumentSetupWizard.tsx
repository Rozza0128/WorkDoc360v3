...
export function DocumentSetupWizard({ companyId, companyName, tradeType, onComplete }: DocumentSetupWizardProps) {
  ...
  // Form will be initialized after getDocumentTypes
  ...
  const calculatedTime = selectedDocTypes.reduce((total, doc) => {
    // Extract numeric value from "5 minutes" format
    const timeValue = parseInt(doc.estimatedTime.split(' ')[0]) || 0;

...
async function setupPlasterMasterDemo() {
  ...
  try {
    ...
    `, [
      ...
      'SW1A 1AA',
      'United Kingdom',
      'Professional Plastering Services - Plaster Master Ltd',
      'Leading plastering contractors in London. Specialising in interior and exterior plastering, rendering, and decorative finishes for residential and commercial projects.',
      '#1e40af', // Blue
      '#f59e0b', // Amber
      null
    ]);
